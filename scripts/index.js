...
const workSection = [{
  ...
  featured_image: 'images/bookstore.png',
  alt_message: 'My_Bookstore_Project',
  overview: ['CANOPY', 'Front End Dev', 2022],
...
},
{
  ...
  popup_description: 'The cryptocurrency webapp provides a list of 100 of the top-rated cryptocurrencies in the world. It also provides a search bar that allows the user to search for a specific cryptocurrency. The app also provides a link to the cryptocurrency details such as market prices and supply.',
  featured_image: 'images/crypto.png',
  alt_message: 'My_Crypto_Project',
  overview: ['CANOPY', 'Front End Dev', 2022],
  overview_image: 'images/circle.svg',
  technologies: ['javaScript', 'Reactjs', 'netlify'],
