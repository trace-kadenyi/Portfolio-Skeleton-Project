...
const workSection = [
  {
    ...
    title: "Bookstore App",
    description:
      "A bookstore application that allows the user to store all the books that they are currently reading.",
    popup_description:
      "The bookstore app stores and retrieves data from the API. It allows the user to add and remove books from the list, change the read status of the book, and filter the books by category.",
    featured_image: "images/books2.png",
  ...
  },
  {
    ...
    description:
      "A to-do list created using Reactjs. It allows the user to enter the activity, time and date, check completed and delete tasks.",
    popup_description:
      "The to-do list is a  ReactJS project that allows the user to fill in the available form with the activity, date, and time. Items can be added, removed, and checked. This information is saved to local storage.",
    featured_image: "images/todo2.png",
  ...
  },
  {
    ...
    popup_description:
      "The cryptocurrency web app provides a list of 100 of the top-rated cryptocurrencies in the world. It also provides a search bar that allows the user to search for a specific cryptocurrency and a link to the cryptocurrency details such as market prices and supply.",
    featured_image: "images/crypto1.png",
